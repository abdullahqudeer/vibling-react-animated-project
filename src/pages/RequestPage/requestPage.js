    ...
    <React.Fragment>
      ...
      <div className="request-demo-page-div">
        <div className="first-div">
          {isSuccess && (
            <div
              className="right  thankyou d-flex justify-content-center align-items-center"
            ...
            >
              <div className="right-center-part">
                <img
                  ...
                  alt=""
                  width={120}
                  style={{ marginBottom: 50, marginTop: 130 }}
                />
                <h2>Thank you!</h2>
                <p className="success-message text-center mt-4">
                  One of our representative will get in touch shortly
                </p>
              </div>
            </div>
          )}
                ...
                <div className="left-part col-lg-6 col-md-12 col-sm-12">
                  <div className="content-div mx-5">
                    ...
                    <p className="pe-5 mt-4">
                      ...
                      authentic content, or reacting to the latest
                      brand-relevant trend, Vidbling drives real results for the
                      world's best brands. Book a demo to find out more.
                    </p>
                  </div>
                </div>
