        ...
        <div className="d-flex justify-content-center align-items-center">
          <div className="content-div mt-4">
            <div className="thanks-div">
              <h1><span className="joining-span">Congratulations on joining the <br/>Vidbling revolution!</span><span>🎉</span></h1>
            </div>
            ...
            <div className="invite-div mt-5">
              <h3 className="friends">
                <span className="invite">Invite</span> your friends to <span className="invite">join now</span>
              </h3>
            </div>
